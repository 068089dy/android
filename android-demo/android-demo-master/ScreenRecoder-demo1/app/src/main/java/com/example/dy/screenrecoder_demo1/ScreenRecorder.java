...
public class ScreenRecorder extends Service {
    ...
    private RtmpStreamingSender mStreamingSender;

    public void setDta(RESFlvDataCollecter dataCollecter, int width, int height, int bitrate, int dpi, MediaProjection mp,RtmpStreamingSender streamingSender) {
        //super(TAG);
        mWidth = width;
        mHeight = height;
        mBitRate = bitrate;
        ...
        mStreamingSender = streamingSender;
...
*/
    ...
    public void run() {
        try {
            ...
            new Thread(mStreamingSender).start();
...
//                    LogTools.d("VideoSenderThread,MediaCodec.INFO_TRY_AGAIN_LATER");
    ...
    public class ScreenRecorderBinder extends Binder {
        public ScreenRecorder getRecordService() {
